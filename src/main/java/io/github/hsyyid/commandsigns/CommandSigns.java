...
@Plugin(id = "io.github.hsyyid.commandsigns", name = "CommandSigns", version = "1.1", description = "This plugins enables server admins to create signs that run a list of commands, targeting the player who clicks them.")
