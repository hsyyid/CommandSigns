CommandSigns [![Build Status](https://travis-ci.org/hsyyid/CommandSigns.svg?branch=master)](https://travis-ci.org/hsyyid/CommandSigns)
=============

**Currently not stable and under heavy development**

A minecraft plugin for Sponge platforms.
Enables servers to have signs which execute various commands.
...
1. `git clone git@github.com:hsyyid/CommandSigns.git`
2. `cd CommandSigns`
...
We use [Gradle] for CommandSigns.

In order to build CommandSigns you simply need to run the `gradle` command.
You can find the compiled JAR file in `./build/libs` labeled similarly to 'CommandSigns-x.x.jar'.

[Source]: https://github.com/hsyyid/CommandSigns
[Wiki]: https://github.com/hsyyid/CommandSigns/wiki
[Issues]: https://github.com/hsyyid/CommandSigns/issues
